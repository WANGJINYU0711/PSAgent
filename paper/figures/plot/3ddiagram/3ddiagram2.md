...
# 数据
data = [
    [72.538, 68.615, 67.791, 67.595, 67.124, 66.928, 66.888, 66.81, 66.69],
    [72.538, 70.537, 69.478, 68.85, 68.458, 68.262, 67.791, 67.634, 67.477],

    [80.664, 75.08, 74.065, 73.557, 73.281, 72.311, 72.265, 72.127, 72.127],
    [80.664, 77.664, 76.511, 75.403, 74.711, 74.25, 73.973, 73.742, 73.557],

    [82.306, 81.57, 81.418, 81.336, 81.317, 81.253, 80.512, 80.461, 79.632],
    [82.306, 82.065, 81.894, 81.818, 81.773, 81.507, 81.482, 81.425, 80.683]
]
...
for i, (metric_data, color, y_pos) in enumerate(zip(data, colors, y_positions)):
    ...
    if i == 4:
        ax.text(beta[-1], y_pos, metric_data[-1] - 2, f'{metric_data[-1]:.2f}',
                color='black', fontsize=20, ha='center', va='bottom', zorder=20)
    elif i == 5:
        ax.text(beta[-1], y_pos-0.3, metric_data[-1] -1, f'{metric_data[-1]:.2f}',
                color='black', fontsize=20, ha='center', va='bottom', zorder=20)
    else:
