...
# 数据
data = [
    [0, 15, 23, 32, 48, 60, 62, 68, 80.12],
    [0, 60, 76, 81, 86, 91, 92, 92, 91.05],
    [0,13,23,32,46,55,62,69,77.22],
    [0,46,79,89,93,95,95,94,95.94],
    [0,10,26,36,45,52,56,55,58.06],
    [0,42,66,76,83,83,83,82,83.78]
]
...
line_width = 2
std_errors = [
    [0.45, 1.23, 0.67, 1.12, 0.89, 0.34, 1.56, 0.78, 1.45],  # 数据集 0 (Citeseer)
    [0.91, 0.56, 1.34, 0.23, 1.67, 0.98, 0.45, 1.01, 0.72],  # 数据集 1 (Citeseer)
    [0.33, 1.45, 0.88, 0.65, 1.12, 0.21, 1.78, 0.44, 0.99],  # 数据集 2 (Cora)
    [1.02, 0.27, 1.56, 0.49, 1.33, 0.76, 0.94, 1.21, 0.38],  # 数据集 3 (Cora)
    [0.67, 1.11, 0.32, 1.45, 0.54, 1.23, 0.88, 0.76, 0.29],  # 数据集 4 (PubMed)
    [0.44, 0.89, 1.01, 0.56, 1.67, 0.33, 0.78, 1.12, 0.65]   # 数据集 5 (PubMed)
]
# 绘制多边形填充、折线、虚线和数据节点
for i, (metric_data, color, y_pos) in enumerate(zip(data, colors, y_positions)):
    ...
    poly_ci = Poly3DCollection(verts_ci, alpha=0.5, facecolor=color, edgecolor='none', zorder=-1)
