...
for index in "${!LABELS[@]}"; do
  ...
  experiment_name="llm_v8_trapasymv4binarymixed_${label}_traponly200_stage45_contract_promptv11b_stage45_gpt41mini_cleanv3_eta03_eps001_etashare005_seed${SEED}"
  run_dir="tmp/${experiment_name}"
  method_session="psagent_trapasymv4_${label}_traponly200_seed${SEED}_runner"
  live_session="psagent_trapasymv4_${label}_traponly200_seed${SEED}_live_wandb"
