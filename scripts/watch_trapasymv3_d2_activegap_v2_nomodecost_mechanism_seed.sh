...
LOG_FILE="${LOG_DIR}/trapasymv3_d2_activegapv2_nomodecost_mechanisms_seed${SEED}_watchdog.log"
LOCK_DIR="${LOG_DIR}/trapasymv3_d2_activegapv2_nomodecost_mechanisms_seed${SEED}_watchdog.lock"
...
LAUNCH_COMMAND="bash scripts/launch_trapasymv3_d2_activegap_v2_nomodecost_mechanism_llm_run.sh ${SEED}"
...
log "mechanism watchdog started; seed=${SEED} poll_seconds=${POLL_SECONDS}"
