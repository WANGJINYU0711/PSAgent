...
WATCHDOG_SESSION="psagent_trapasymv6small30_full_d3_4of5_11c_seed${SEED}_watchdog"
...
BASE_4OF5_FAMILY="shared_basin_strong_prefix_dedup_profile_switch_trap_asym_v6_small30_4of5"
PS_2OF5_FAMILY="shared_basin_strong_prefix_dedup_profile_switch_trap_asym_v6_small30_2of5"
PS_ALLUNSHARE_FAMILY="shared_basin_strong_prefix_dedup_profile_switch_trap_asym_v6_small30_all_unshare"
PS_ALLSHARE_FAMILY="shared_basin_strong_prefix_dedup_profile_switch_trap_asym_v6_small30_all_share"
...
runner_session_for_label() {
  local label="$1"
  printf 'psagent_trapasymv6small30_full_d3_%s_seed%s_runner' "$label" "$SEED"
}

wandb_session_for_label() {
  local label="$1"
  printf 'psagent_trapasymv6small30_full_d3_%s_seed%s_wandb' "$label" "$SEED"
}
...
tmux new-session -d -s "$WATCHDOG_SESSION" -n watchdog \
  "cd '$ROOT_DIR' && source '$ENV_FILE' && scripts/watch_trapasymv6_small30_full_d3_4of5_11conditions_seed.sh '${SEED}' 2>&1 | tee -a '${GROUP_DIR}/watchdog.stdout'"
