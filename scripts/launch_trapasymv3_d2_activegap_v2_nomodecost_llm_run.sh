...
SEED="${1:-1}"
EXPERIMENT_NAME="llm_v8_trapasymv3efficientanchor4of5_stage45_contract_promptv11b_stage45_gpt41mini_cconfig_d2_activegapv2_nomodecost_reason135_eps001_10x10_4methods_seed${SEED}"
WANDB_GROUP="trapasymv3_d2_activegapv2_nomodecost_seed${SEED}"
RUN_DIR="tmp/${EXPERIMENT_NAME}"
METHOD_SESSION="psagent_trapasymv3_d2_activegapv2_nomodecost_seed${SEED}_4m"
LIVE_SESSION="psagent_trapasymv3_d2_activegapv2_nomodecost_seed${SEED}_live_wandb"
MONITOR_SESSION="psagent_trapasymv3_d2_activegapv2_nomodecost_seed${SEED}_monitor"
